...
const EN: CirclesLocale = {
	...
	drill: {
		...
		activate: {
			...
			needTurns: 'A circle needs at least three members with a turn. Add more, then activate.',
...
const FR: CirclesLocale = {
	...
	drill: {
		...
		activate: {
			...
			needTurns: 'Un cercle a besoin d’au moins trois membres avec un tour. Ajoutez-en, puis activez.',
...
const ES: CirclesLocale = {
	...
	drill: {
		...
		activate: {
			...
			needTurns: 'Un círculo necesita al menos tres integrantes con turno. Añade más y luego activa.',
