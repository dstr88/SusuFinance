...
// product/form names (Form 8949, Schedule D, IRS, SusuFinance). ES/FR are first-pass.
...
export const en: SettingsLocale = {
  lang: 'en',
  pageTitle: 'Settings | SusuFinance',
  title: 'Settings',
  ...
  jurisdictionDesc:
    ...
    'SusuFinance is a record-keeping tool — nothing here constitutes tax, legal, or filing advice. ' +
...
export const es: SettingsLocale = {
  ...
  jurisdictionDesc:
    ...
    'SusuFinance es una herramienta de registro — nada de lo aquí presentado constituye asesoramiento fiscal, legal o de declaración. ' +
...
export const fr: SettingsLocale = {
  lang: 'fr',
  pageTitle: 'Paramètres | SusuFinance',
  title: 'Paramètres',
  ...
  jurisdictionDesc:
    ...
    'SusuFinance est un outil de tenue de registres — rien ici ne constitue un conseil fiscal, juridique ou de déclaration. ' +
