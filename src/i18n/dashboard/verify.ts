...
export const en: VerifyDashboardLocale = {
  ...
  proveDnsStep: 'Add a TXT record to your domain (host “@”, or “_susufinance-verify”) with this exact value, then verify:',
  ...
  proofUnreachable: '⚠ Couldn’t reach the verification file. Publish it at /.well-known/susufinance-verify.json and try again.',
...
export const es: VerifyDashboardLocale = {
  ...
  proveDnsStep: 'Añade un registro TXT a tu dominio (host «@» o «_susufinance-verify») con este valor exacto, y luego verifica:',
  ...
  proofUnreachable: '⚠ No se pudo acceder al archivo de verificación. Publícalo en /.well-known/susufinance-verify.json e inténtalo de nuevo.',
...
export const fr: VerifyDashboardLocale = {
  ...
  proveDnsStep: 'Ajoutez un enregistrement TXT à votre domaine (hôte « @ » ou « _susufinance-verify ») avec cette valeur exacte, puis vérifiez :',
  ...
  proofUnreachable: '⚠ Impossible d’accéder au fichier de vérification. Publiez-le à /.well-known/susufinance-verify.json et réessayez.',
